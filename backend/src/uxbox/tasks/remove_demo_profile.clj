...
(defn handler
  ...
  (db/with-atomic [conn db/pool]
    #_(remove-file-images conn (:id props))
    #_(remove-images conn (:id props))
    #_(remove-profile conn (:id props))))
...
;;       inner join file as f on (f.id = fi.file_id)
